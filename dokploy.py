...
API_URL = "http://3.110.227.137:3000//api/project.all"
api_key = "YbXmMKgaIjfYWCkOtrMAKkjvYbwDKVDjsiImgBjezjdgfhypotJrtDATlpyvqxlM"
app_name = "job-portal-backend-t233jl"
